...
{
    public record DeleteCompanyCommand : IRequest<SettingsViewModel?>
    {
        public string? Name { get; init; }
    }

    internal class DeleteCompanyCommandHandler : IRequestHandler<DeleteCompanyCommand, SettingsViewModel?>
    {
        ...
        public async Task<SettingsViewModel?> Handle(DeleteCompanyCommand request, CancellationToken cancellationToken)
        {
