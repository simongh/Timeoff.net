...
{
    public record UpdateScheduleCommand : Types.ScheduleModel, IRequest<ScheduleViewModel>
    {
    ...
    internal class UpdateScheduleCommandHandler : IRequestHandler<UpdateScheduleCommand, ScheduleViewModel>
    {
