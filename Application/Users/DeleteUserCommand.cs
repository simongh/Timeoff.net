...
{
    public record DeleteUserCommand : IRequest<UsersViewModel>
    {
        public int Id { get; init; }
    }

    internal class DeleteUserCommandHandler : IRequestHandler<DeleteUserCommand, UsersViewModel>
    {
        ...
        public async Task<UsersViewModel> Handle(DeleteUserCommand request, CancellationToken cancellationToken)
        {
