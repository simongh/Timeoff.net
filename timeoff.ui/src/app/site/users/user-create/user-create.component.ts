...
import { DatePickerDirective } from '../../settings/public-holidays/date-picker.directive';
...
export class UserCreateComponent implements OnInit {
  ...
  public add() {
    ...
    this.usersSvc
      ...
      .subscribe({
        next: () => {
          this.messagesSvc.isSuccess('New user account successfully added');
        ...
        error: (e: HttpErrorResponse) => {
          if (e.status == 400) {
            ...
            this.messages = isError('Unable to add new user');
          }
        },
      });
  }
