...
{
    public record DeleteLeaveTypeCommand : IRequest<ResultModels.SettingsViewModel>
    {
        public int Id { get; init; }
    }

    internal class DeleteLeaveTypeCommandHandler : IRequestHandler<DeleteLeaveTypeCommand, ResultModels.SettingsViewModel>
    {
        ...
        public async Task<ResultModels.SettingsViewModel> Handle(DeleteLeaveTypeCommand request, CancellationToken cancellationToken)
        {
