...
{
    public record UpdateLeaveTypesCommand : IRequest<ResultModels.SettingsViewModel>, IValidated
    {
    ...
    internal class UpdateLeaveTypesCommandHandler : IRequestHandler<UpdateLeaveTypesCommand, ResultModels.SettingsViewModel>
    {
        ...
        public async Task<ResultModels.SettingsViewModel> Handle(UpdateLeaveTypesCommand request, CancellationToken cancellationToken)
        {
