...
{
    public record UpdateIntegrationApiCommand : IRequest<ResultModels.IntegrationApiViewModel>
    {
    ...
    internal class UpdateIntegrationApiCommandHandler : IRequestHandler<UpdateIntegrationApiCommand, ResultModels.IntegrationApiViewModel>
    {
        ...
        public async Task<ResultModels.IntegrationApiViewModel> Handle(UpdateIntegrationApiCommand request, CancellationToken cancellationToken)
        {
